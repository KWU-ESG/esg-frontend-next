  ...
  const onClickSubmit = async () => {
    ...
    if (title && contents) {
      try {
        ...
        console.log("성공시 내용출력: ", postData.contents);
        console.log(location.origin);
        await axios.post("/company/create", postData);
  ...
  return (
    <>
      ...
      <Wrapper>
        ...
        <ButtonWrapper>
          <CustomSubmitButton onClick={onClickSubmit}>
            🖼 이미지 추가
          </CustomSubmitButton>
          <SubmitButton onClick={onClickSubmit} isActive={isActive}>
            🖋 작성하기
          </SubmitButton>
        </ButtonWrapper>
      </Wrapper>
