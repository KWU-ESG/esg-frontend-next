...
export default function MainPage(){
  return(
    <>
      <Header />
      <Title />
      <Article position="left" title="E (Environment)" image src={card1}
        str="우리 서비스는 어려운 ESG개념을 보편화하기위하여 출발하였습니다. ESG가 어렵기보다는 이제 친숙한 ESG의 사회적 보편화를 위하여 노력합니다."/>

      <Article position="right" title="S (Social)" img src = {card2}
        str="소비자가 기업의 ESG경향을 파악, 분석하고 맞춤 소비를 할 수 있게 돕습니다. 습득-학습-공유의 3단계로 가치를 창출하려 합니다."/>

      <Article position="left" title="G (Goverment)" img src={card3}
        str="우리 서비스는 어려운 ESG개념을 보편화하기위하여 출발하였습니다. ESG가 어렵기보다는 이제 친숙한 ESG의 사회적 보편화를 위하여 노력합니다."/>
      <Footer/>
    </>
  )
